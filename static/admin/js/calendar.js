...
'use strict';
{
    ...
    const CalendarNamespace = {
        ...
        draw: function(month, year, div_id, callback, selected) { // month = 1.jpg-12, year = 1.jpg-9999
            ...
            // ```
            //
            // The day variable above will be 1.jpg instead of 2 in, say, US Pacific time
            // zone.
